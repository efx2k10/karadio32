...
int inaudioFN = 1;
int isModeChangedFN = 0;
int PIN_IN_AUDIO_FN = 21;
...
gpio_pad_select_gpio(PIN_IN_AUDIO_FN);
gpio_set_direction(PIN_IN_AUDIO_FN, GPIO_MODE_OUTPUT);
	...
	if (inaudioFN == 0 ) {
		...
		isModeChangedFN = 0;
		gpio_set_level(PIN_IN_AUDIO_FN, inaudioFN);
	}
	else {
		inaudioFN = 0;
		isModeChangedFN = 1;
